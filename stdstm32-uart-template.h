...
// catch legacy defines
  ...
  #elif defined UART$_USE_UART1_PB14PB15 // only C5
  ...
  #define UART$_IRQHandler        USART1_IRQHandler
    ...
    // C5: PA9/PA10 and PB6/PB7 are AF7 as set above, PB14/PB15 are AF4. the AF4 is
    // datasheet-verified on C551/C552/C562, and assumed to hold for the smaller parts.
    // PC4/PC5 is not a USART1 mapping on C5, it is USART3_RX.
    #if defined UART$_USE_UART1_PC4PC5
      #error UART$_USE_UART1_PC4PC5 not available on STM32C5 !
    #elif defined UART$_USE_UART1_PB14PB15
      #undef UART$_IO_AF
  ...
  #elif defined STM32WL
  #elif defined STM32C5
    // C5 has USART2 only on PA2/PA3 (AF7, as set above) and PD5/PD6, and PD5/PD6 is not
    // bonded up to LQFP64. PB3/PB4 and PB3/PA15 are USART3 pins on C5, not USART2.
    #if defined UART$_USE_UART2_PD5PD6
      #error UART$_USE_UART2_PD5PD6 not bonded on STM32C5 packages up to LQFP64 ! use UART$_USE_UART2_PA2PA3
    #elif defined UART$_USE_UART2_PB3PB4 || defined UART$_USE_UART2_PA14PA15 || \
          defined UART$_USE_UART2_PB3PA15
      #error UART$_USE_UART2 mapping not available on STM32C5 ! use UART$_USE_UART2_PA2PA3
    #endif
  #endif
  ...
  #elif defined STM32C5
    // C5 USART3 is AF7 as set above, and only PC10/PC11 is bonded up to LQFP64.
    // PB3/PB4 is USART3 too, but on AF11, and is not offered as a mapping here.
    // the C5 parts without USART3 are caught by the CMSIS presence macro.
    #if !defined USART3
      #error UART3 NOT AVAILABLE !
    #elif defined UART$_USE_UART3_PB10PB11
      #error UART$_USE_UART3_PB10PB11 not available on STM32C5, PB11 is not a USART3 pin ! use UART$_USE_UART3_PC10PC11
    #elif defined UART$_USE_UART3_PB8PB9
      #error UART$_USE_UART3_PB8PB9 not available on STM32C5 ! use UART$_USE_UART3_PC10PC11
    #endif
  #endif
  ...
  #define UART$_UARTx             UART4
    ...
    #define UART$_TX_IO           IO_PC10
    #define UART$_RX_IO           IO_PC11
  #elif defined UART$_USE_UART4_PA0PA1 // only F7, C5 // was UART4_REMAPPED
  ...
  #define UART$_UARTx             LPUART1
    ...
    #elif defined STM32C5
      // C5 silicon swap: AF table has PA2=LPUART1_RX, PA3=LPUART1_TX (opposite of G4/WL).
      // override the TX/RX IO assignments above for C5.
      #undef UART$_TX_IO
      #undef UART$_RX_IO
    ...
    #define UART$_IO_AF           IO_AF_8
  #elif defined UART$_USE_LPUART1_PA9PA10 // only C5, not swapped
    #define UART$_TX_IO           IO_PA9
    #define UART$_RX_IO           IO_PA10
    #define UART$_IO_AF           IO_AF_3
  #elif defined UART$_USE_LPUART1_PB6PB7 // only C5, not swapped
    #define UART$_TX_IO           IO_PB6
    #define UART$_RX_IO           IO_PB7
    #define UART$_IO_AF           IO_AF_8
  #endif
  ...
  #elif defined STM32WL
  #elif defined STM32C5
    // C5 has LPUART1 on PA2/PA3 (AF3, RX/TX swapped, handled above), PA9/PA10 (AF3) and
    // PB6/PB7 (AF8). PC0/PC1 are bonded up to LQFP64, but carry SPI2, not LPUART1.
    #if defined UART$_USE_LPUART1_PC1PC0
      #error UART$_USE_LPUART1_PC1PC0 not available on STM32C5, PC0/PC1 are not LPUART1 pins ! use UART$_USE_LPUART1_PA9PA10 or UART$_USE_LPUART1_PB6PB7
    #endif
  #endif
...
#elif defined STM32G4 || defined STM32WL || defined STM32C5
  #define REG_DR        TDR
  #define REG_SR        ISR
...
#elif defined STM32C5
  LL_USART_DisableFIFO(UART$_UARTx);
  LL_USART_SetTXFIFOThreshold(UART$_UARTx, LL_USART_FIFO_THRESHOLD_1_8);
  LL_USART_SetRXFIFOThreshold(UART$_UARTx, LL_USART_FIFO_THRESHOLD_1_8);
#endif
#else
...
#if defined STM32G4 || defined STM32F3 || defined STM32WL || defined STM32F0 || defined STM32C5
#if !defined UART$_USE_RXERRORCOUNT
...
#elif defined STM32C5
  // supported scope is C562 and below: C531/532/542 (AN2606 Table 20) and C55xxx/562
  // (Table 23) both boot on USART1 PA9/PA10, USART2 PA2/PA3 and UART4 PA0/PA1.
  // C55xxx/562 additionally boot on USART3 PD8/PD9, not offered as a mapping here.
  #if defined UART$_USE_UART1_PA9PA10 || defined UART$_USE_UART2_PA2PA3 || defined UART$_USE_UART4_PA0PA1
    #define UART$_HAS_SYSTEMBOOT
  #endif
