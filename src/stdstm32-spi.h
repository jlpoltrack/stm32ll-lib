...
#if defined STM32C5
      LL_SPI_SetClockPolarity(SPI_SPIx, LL_SPI_CLOCK_POLARITY_LOW);
      LL_SPI_SetClockPhase(SPI_SPIx, LL_SPI_CLOCK_PHASE_1_EDGE);
#else
...
#if defined STM32C5
      LL_SPI_SetClockPolarity(SPI_SPIx, LL_SPI_CLOCK_POLARITY_LOW);
      LL_SPI_SetClockPhase(SPI_SPIx, LL_SPI_CLOCK_PHASE_2_EDGE);
#else
      LL_SPI_SetClockPolarity(SPI_SPIx, LL_SPI_POLARITY_LOW);
...
#if defined STM32C5
      LL_SPI_SetClockPolarity(SPI_SPIx, LL_SPI_CLOCK_POLARITY_HIGH);
      LL_SPI_SetClockPhase(SPI_SPIx, LL_SPI_CLOCK_PHASE_1_EDGE);
#else
...
LL_SPI_InitTypeDef SPI_InitStruct = {};
...
#ifndef SPI_USE_SUBGHZSPI
  {
    ...
    uint32_t c5_cfg1 = LL_SPI_DATA_WIDTH_8_BIT | _spi_baudrate(c5_speed);
    LL_SPI_SetConfig(SPI_SPIx, c5_cfg1, c5_cfg2);
    LL_SPI_DisableCRC(SPI_SPIx);
  }
#endif // !SPI_USE_SUBGHZSPI
